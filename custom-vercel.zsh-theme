# https://github.com/willmendesneto/hyper-oh-my-zsh/blob/master/hyper-oh-my-zsh.zsh-theme
...
# Define a faded color (e.g., gray)
FADED_COLOR="%F{245}" # Gray color
RESET_COLOR="%f"      # Reset to default color
# Set RPROMPT to display current time in faded color
RPROMPT='${FADED_COLOR}%D{%H:%M} ${RESET_COLOR}'
